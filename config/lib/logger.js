...
var elasticUrl = 'https://search-application-logs-ecymm72pkhkycus6nfmyl6rrtu.us-east-1.es.amazonaws.com';

if (process.env.NODE_ENV == 'production') {
  elasticUrl = 'https://search-application-logs-a2xvccrky7dklje7wxtv3vrxpy.ap-southeast-1.es.amazonaws.com';
}
...
logger.setupFileLogger = function setupFileLogger() {
  ...
  try {
    ...
    if (fs.openSync(fileLoggerTransport.filename, 'a+')) {
      ...
      logger.add(winston.transports.Console, fileLoggerTransport);
    }
